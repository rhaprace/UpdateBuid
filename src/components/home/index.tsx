...
const Home: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="h-screen bg-gradient-to-br from-[#000059] to-[#D9D9D9] flex flex-col justify-center"
    >
      <motion.div
      ...
      >
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="mt-4 text-lg text-gray-200">
            Achieve your health and fitness goals with our personalized meal
            plans and workout routines.
          </p>
